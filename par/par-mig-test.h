/// @file
/// @brief parameter file for the migration test
...
#define INCLUDE_LUMINOSITY false
...
/// @details is a string
#define OUTPUT_FILE "migration-dr0_01.dat"

/// @brief file name of output log
/// @details is a string
#define LOG_FILE "migration-dr0_01.log"
...
#define OUTPUT_INTERVAL (0.0015*SEC)
