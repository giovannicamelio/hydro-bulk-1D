/// @file
/// @brief parameter file for the migration of the multicomponent fluid with luminosity
...
/// @details is a string
#define OUTPUT_FILE "mig-mfq-murca.dat"

/// @brief file name of output log
/// @details is a string
#define LOG_FILE "mig-mfq-murca.log"
