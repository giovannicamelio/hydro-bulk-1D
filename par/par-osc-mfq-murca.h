/// @file
/// @brief parameter file for the oscillation of the multicomponent fluid with luminosity
...
/// @details is a string
#define OUTPUT_FILE "osc-mfq-murca.dat"

/// @brief file name of output log
/// @details is a string
#define LOG_FILE "osc-mfq-murca.log"
